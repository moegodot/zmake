...
/// </summary>
public sealed class ArtifactName : IEquatable<ArtifactName>
{
    ...
    internal static readonly ArtifactName ZMake = new ArtifactName("moe.kawayi","zmake",Program.VersionString);
    ...
    private ArtifactName(string groupId, string artifactId, string version)
    {
    ...
    public static ArtifactName Parse(string text)
    {
        ...
        [NotNullWhen(false)]out string? reason)
    {
        ...
        result = new ArtifactName(groupId, artifactId, version);
        return true;
    }
